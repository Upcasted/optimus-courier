...
trait FpdfTplTrait
{
    ...
    public function beginTemplate($width = null, $height = null, $groupXObject = false)
    {
        ...
        // initiate buffer with current state of OptimusCourier_FPDF
        $buffer = "2 J\n"
    ...
    /* overwritten OptimusCourier_FPDF methods: */
    ...
    protected function _putimages()
    {
        ...
        foreach ($this->templates as $key => $template) {
            ...
            $this->_put('/Resources 2 0 R'); // default resources dictionary of OptimusCourier_FPDF
