...
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\CrossReference\CrossReferenceException;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Filter\FilterException;
...
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\StreamReader;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfArray;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfBoolean;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfDictionary;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfHexString;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfIndirectObject;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfIndirectObjectReference;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfName;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfNull;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfNumeric;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfStream;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfString;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfToken;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfType;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfParser\Type\PdfTypeException;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfReader\PageBoundaries;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfReader\PdfReader;
use OptimusCourier\Dependencies\setasign\Fpdi\PdfReader\PdfReaderException;
...
trait FpdiTrait
{
    ...
    /**
     * A map from object numbers of imported objects to new assigned object numbers by OptimusCourier_FPDF.
     *
     * @var array
     */
    protected $objectMap = [];
